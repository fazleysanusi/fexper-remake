...
<html lang="en">
   <head>
      ...
      #jumbotron{
        margin-top:20px;
        background: url("image/graph.png") no-repeat center fixed; 
   ...
   <!-- 4th row -->
     ...
     <p class="text-left " style="text-size:20px; font-weight:bold; -webkit-text-stroke: 1px black;">Resistance @</p>
